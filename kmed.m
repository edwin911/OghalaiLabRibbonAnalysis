function [KX,KY,KZ,Centroid] = kmed(kx,ky,kz,nucleusCount)
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here

% K clustering to improve threshholding
%% kmedoids
%use kmedoids clustering, setting the number of regions = to the number of
...
[idx,C] = kmedoids(X,nucleusCount,'Distance','sqeuclidean',...
